...
/// <summary>
/// Request para enviar una Nota de Débito Electrónica.
/// InformacionReferencia es OBLIGATORIA.
/// </summary>
public class ProcesoNotaDebitoRequest
{
    /// <summary>
    ...
    public string TipoDocumento { get; set; } = "02"; // Nota de Débito
    public string Sucursal { get; set; } = "0010010001";
    public string Terminal { get; set; } = "0001";
    public string? CondicionVenta { get; set; }
    public int PlazoCredito { get; set; }
    public string? MedioPago { get; set; }
    public List<DetalleServicioNotaDebitoRequest>? DetalleServicios { get; set; }
    ...
    /// </summary>
    public InformacionReferenciaNotaDebitoRequest InformacionReferencia { get; set; } = new();
}

/// <summary>
/// Detalle de servicio para Nota de Débito
/// </summary>
public class DetalleServicioNotaDebitoRequest
{
...
/// <summary>
/// Información de referencia al documento original para Nota de Débito
/// </summary>
public class InformacionReferenciaNotaDebitoRequest
{
    /// <summary>
    ...
    /// </summary>
    public string Codigo { get; set; } = "03"; // Corrige monto es típico para ND
